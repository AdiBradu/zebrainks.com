...
import './GraphicDesign.component.scss'
...
export default function GraphicDesign() {
    ...
    const range = 1/7
    const screen01TextOpac = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [1, 0, 0, 0, 0, 0, 0, 0])
    const screen02TextOpac = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [0, 1, 0, 0, 0, 0, 0, 0])
    const screen03TextOpac = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [0, 0, 1, 0, 0, 0, 0, 0])
    const screen04TextOpac = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [0, 0, 0, 1, 0, 0, 0, 0])
    const screen05TextOpac = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [0, 0, 0, 0, 1, 0, 0, 0])
    const screen06TextOpac = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [0, 0, 0, 0, 0, 1, 0, 0])
    const screen07TextOpac = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [0, 0, 0, 0, 0, 0, 1, 0])
    const screen08TextOpac = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [0, 0, 0, 0, 0, 0, 0, 1])

    const mountainScale = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [1, 1, 1, 1, 1, 1, 1, 1])
    const mountainX = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vw', '5vw', '10vw', '0vw', '-5vw', '-5vw', '10vw', '10vw'])
    const mountainY = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['5vh', '20vh', '100vh', '100vh', '10vh', '100vh', '100vh', '100vh'])

    const birdsY = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vh', '55vh', '100vh', '125vh', '100vh', '100vh', '100vh', '100vh'])
    const birdsX = useTransform(scrollYProgress, [0, 0.5, 1], ['0vw', '5vw', '10vw'])
    const birdsScale = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [1, 0.7, 0.35, 0, 0, 0, 0, 0])

    const upCloudY = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vh', '5vh', '55vh', '100vh', '100vh', '100vh', '100vh', '100vh'])
    const upCloudX = useTransform(scrollYProgress, [0, 0.5, 1], ['0vw', '-3.5vw', '-6vw'])

    const midCloudY = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vh', '-5vh', '55vh', '100vh', '100vh', '100vh', '100vh', '100vh'])
    ...
    const downCloudY = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vh', '-8vh', '35vh', '100vh', '100vh', '100vh', '100vh', '100vh'])

    const rocketX = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vw', '0vw', '0vw', '-10vw', '0vw', '0vw', '0vw', '-10vw'])
    const rocketY = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vh', '-8vh', '35vh', '45vh', '15vh', '0vh', '20vh', '20vh'])
    const scaleRocket = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [1, 1, 1, 1, 0.8, 0.7, 0.5, 0.5])

    const opacStars = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [0, 0, 1, 1, 1, 1, 1, 1])
    const starsX = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vw', '0vw', '0vw', '60vw', '60vw', '60vw', '0vw', '0vw'])
    const starsY = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vh', '0vh', '0vh', '20vh', '0vh', '0vh', '0vh', '0vh'])
    const scaleStars = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [0, 0, 0.8, 1.1, 1, 1, 1, 1])

    const earthX = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['100vw', '100vw', '100vw', '100vw', '100vw', '0vw', '-100vw', '-100vw'])
    const earthY = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vh', '0vh', '0vh', '0vh', '0vh', '-50vh', '-50vh', '0vh'])

    const marsX = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vw','0vw', '0vw', '0vw','0vw', '0vw', '0vw','0vw'])
    const marsY = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], ['0vh','0vh', '0vh', '0vh','0vh', '0vh', '-50vh','-40vh'])
    const scaleMars = useTransform(scrollYProgress, [0, range, 2*range, 3*range, 4*range, 5*range, 6*range, 1], [1, 1, 1, 1, 1, 1, 1, 1.4])
    ...
    return (
        <AnimatePresence exitBeforeEnter>
            ...
            >
                ...
                <motion.svg style={{ scale: birdsScale, x: birdsX, y: birdsY, originX: '50%', originY: '50%', zIndex:2006}} className="birds" width="1333" height="873" viewBox="0 0 1333 873" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.svg style={{scale: mountainScale, x: upCloudX, y: upCloudY, originX: '50%', originY: '50%', transition: {...transition}}} className="upCloud" width="510" height="171" viewBox="0 0 510 171" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.svg style={{scale: mountainScale, x: midCloudX, y: midCloudY, originX: '50%', originY: '50%', transition: {...transition}}} className="midCloud" width="284" height="96" viewBox="0 0 284 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.svg style={{zIndex:1000, scale: scaleRocket, x: rocketX, y: rocketY, originX: '50%', originY: '50%', transition: {...transition}}} className="rocket" width="202" height="363" viewBox="0 0 202 363" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.svg style={{scale: mountainScale, x: downCloudX, y: downCloudY, originX: '50%', originY: '50%', transition: {...transition}}} className="downCloud" width="236" height="80" viewBox="0 0 236 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.svg style={{zIndex:2005, scale: mountainScale, x: mountainX, y: mountainY, originX: '50%', originY: '50%', transition: {...transition}}} className="mountain" width="2219" height="1068" viewBox="0 0 2219 1068" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.svg style={{opacity: opacStars, scale: scaleStars, x: starsX, y: starsY, originX: '50%', originY: '50%'}} className="stars" width="580" height="540" viewBox="0 0 580 540" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.svg style={{x: earthX, y: earthY, originX: '50%', originY: '50%'}} className="earth" width="721" height="721" viewBox="0 0 721 721" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.svg style={{scale: scaleMars, x: marsX, y: marsY, originX: '50%', originY: '50%'}} className="mars" width="1202" height="1202" viewBox="0 0 1202 1202" fill="none" xmlns="http://www.w3.org/2000/svg">
